Router.components.main_left2=function(parentDom,data){
...
var html='<div class="left">        <div class="bt">列表二</div>        <br>       <div e-for="list" e-event="onclick=changeRight" e-attr="title=title">{{txt}} {{$_index}}</div>  </div>';
var app=new Eng({
        el:html,
        parent:parentDom,
        id:'main_left2',
